...
set title "\n"
set label 1 "               Grafico de Pastel\n               Frecuencia de Syscalls\n" at graph 0,1.125 left font 'Arial-Bold,14'
...
plot for [i=1:STATS_records] dataname u (0):(0):(1):(Ai):(Ai=Ai+ang($2)):(i) every ::i::i with circle linecolor palette,\
         ...
         for [i=1:STATS_records]dataname u (1.45):((i*0.21)-2.0):(sprintf('%i %s', $2 ,stringcolumn(1))) every ::i::i with labels left font 'Arial-Bold,10',\
